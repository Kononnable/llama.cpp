...
struct common_params {
    ...
    int32_t n_cpu_moe          = -1;    // -1 is unset; with -sm tensor + expert '-ts e' entries: keep experts of the first N layers on the CPU ('e') entries, rest on the GPU (plain) entries
